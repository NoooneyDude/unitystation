...
namespace UI.Objects.Atmospherics.ACU
{
	...
	public class GUI_ACUThresholdsPage : GUI_ACUPage
	{
		...
		public void SetThreshold(GUI_ACUThresholdEntry entry, int thresholdIndex)
		{
			...
			AcuUi.EditValueModal.Open(oldValue.ToString(), (string stringValue) =>
			{
		...
		private void UpdateThresholdEntry(int index, ThresholdType type, string thresholdName, float[] values, Gas gas)
		{
