...
namespace UI.Objects.Atmospherics.ACU
{
	...
	public class GUI_ACUScrubberEntry : DynamicEntry
	{
		...
		private static readonly Dictionary<Gas, string> gasFormulaRT = new Dictionary<Gas, string>()
		{
		...
		private static readonly Gas[] line1 = { Gas.Oxygen, Gas.Nitrogen, Gas.CarbonDioxide, Gas.WaterVapor, Gas.NitrousOxide, Gas.Nitryl, Gas.Hydrogen };
		private static readonly Gas[] line2 = { Gas.Plasma, Gas.Tritium, Gas.Freon, Gas.Miasma, Gas.BZ };
		private static readonly Gas[] line3 = { Gas.Pluoxium, Gas.Stimulum, Gas.HyperNoblium };
		...
		public void UpdateText()
		{
			...
			foreach (Gas[] line in new Gas[][] { line1, line2, line3 })
			{
				var filteredGasesStr = new StringBuilder();
				foreach (Gas gas in line)
				{
