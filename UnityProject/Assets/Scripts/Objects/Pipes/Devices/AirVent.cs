...
namespace Pipes
{
	...
	/// </summary>
	public class AirVent : MonoPipe, IServerSpawn, IAPCPowerable, IACUControllable
	{
		public enum Mode
		{
			Out = 0,
		...
		public override void OnSpawnServer(SpawnInfo info)
		{
			...
			pipeMix = selfSufficient ? GasMix.NewGasMix(GasMixes.Air) : pipeData.GetMixAndVolume.GetGasMix();
